...
fn bench_statistics_update_methods(c: &mut Criterion) {
    ...
    group.bench_function("update_aspiration_stats", |b| {
        ...
        b.iter(|| {
            ...
            let should_track_stats = engine_config.enable_statistics 
                && !engine_config.disable_statistics_in_production;
...
fn bench_conditional_statistics_check(c: &mut Criterion) {
    ...
    group.bench_function("full_conditional_check", |b| {
        ...
        b.iter(|| {
            let should_track_stats = config.enable_statistics 
                && !config.disable_statistics_in_production;
