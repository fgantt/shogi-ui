...
use shogi_engine::{
    ...
    types::{CapturedPieces, Player, AdvancedReductionConfig, AdvancedReductionStrategy},
};
...
fn benchmark_comprehensive_advanced_strategies(c: &mut Criterion) {
    ...
    group.bench_function("comprehensive_analysis", |b| {
        b.iter(|| {
            ...
            config_advanced.advanced_reduction_config.strategy = AdvancedReductionStrategy::Combined;
