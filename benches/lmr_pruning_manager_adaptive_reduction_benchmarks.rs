...
use shogi_engine::{
    ...
    types::{CapturedPieces, Player, LMRConfig, PositionClassification, GamePhase},
};
...
fn benchmark_pruning_manager_adaptive_reduction_verification(c: &mut Criterion) {
    ...
    group.bench_function("verification", |b| {
        b.iter(|| {
            ...
            let params_synced = pruning_manager.parameters.lmr_base_reduction == lmr_config.base_reduction &&
                               ...
                               pruning_manager.parameters.lmr_enable_adaptive_reduction == lmr_config.enable_adaptive_reduction;
