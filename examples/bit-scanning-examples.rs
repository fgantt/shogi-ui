...
fn shogi_specific_examples() {
    ...
    println!("Rank 7 is promotion zone for Black: {}", 
             is_promotion_zone(rank_7_square, Player::Black));
    println!("Rank 1 is promotion zone for White: {}", 
             is_promotion_zone(rank_1_square, Player::White));
    println!("Center is promotion zone: {}", 
...
fn api_integration_examples() {
    ...
    println!("API analysis - Ranks: {}, Files: {}, Diagonals: {}", 
...
fn global_optimizer_examples() {
    ...
    println!("GlobalOptimizer - Count: {}, First: {:?}, Positions: {:?}", 
             count, pos, positions);
    
    // Geometric analysis
    let geometry = integration::GlobalOptimizer::analyze_geometry(bitboard);
    println!("Geometry analysis - Ranks: {}, Files: {}, Diagonals: {}", 
