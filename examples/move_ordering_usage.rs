...
use shogi_engine::types::{Move, Player, Position, PieceType};
...
fn example_2_with_killer_moves() {
    ...
    let move1 = Move::new_move(Position::new(6, 4), Position::new(5, 4), PieceType::Pawn, Player::Black, false);
    let move2 = Move::new_move(Position::new(8, 1), Position::new(7, 1), PieceType::Lance, Player::Black, false);
...
fn example_3_statistics() {
    ...
    let moves = vec![
        Move::new_move(Position::new(6, 4), Position::new(5, 4), PieceType::Pawn, Player::Black, false),
        Move::new_move(Position::new(6, 5), Position::new(5, 5), PieceType::Pawn, Player::Black, false),
    ];
