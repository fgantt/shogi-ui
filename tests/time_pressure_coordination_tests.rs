...
mod time_pressure_calculation_tests {
    ...
    fn test_custom_time_pressure_thresholds() {
        ...
        assert_eq!(TimePressure::from_remaining_time_percent(35.0, &thresholds), TimePressure::None);
        assert_eq!(TimePressure::from_remaining_time_percent(25.0, &thresholds), TimePressure::Low);
        assert_eq!(TimePressure::from_remaining_time_percent(15.0, &thresholds), TimePressure::Medium);
...
mod time_pressure_integration_tests {
    ...
    fn test_normal_operation_no_time_pressure() {
        ...
        assert!(iid_stats.iid_searches_performed > 0 || iid_stats.positions_skipped_time_pressure >= 0);
    }
}
