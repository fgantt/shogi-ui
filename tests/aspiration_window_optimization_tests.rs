...
use shogi_engine::search::{SearchEngine, IterativeDeepening};
...
mod aspiration_window_optimization_tests {
    ...
    fn test_window_size_optimization_algorithms() {
        ...
        for (depth, prev_score, failures, complexity, time_remaining, total_time, success_rate, move_count) in test_cases {
            let window_size = engine.calculate_comprehensive_window_size(
                depth, prev_score, failures, complexity, time_remaining, total_time, success_rate, move_count
            );
    ...
    fn test_aspiration_window_configuration_tuning() {
        ...
        let configurations = vec![
            ("Small window", AspirationWindowConfig {
                enabled: true,
                base_window_size: 25,
            ...
            ("Large window", AspirationWindowConfig {
                enabled: true,
            ...
            ("No dynamic scaling", AspirationWindowConfig {
                enabled: true,
                base_window_size: 50,
            ...
            ("No adaptive sizing", AspirationWindowConfig {
                enabled: true,
                base_window_size: 50,
                dynamic_scaling: true,
                max_window_size: 200,
