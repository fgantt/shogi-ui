...
mod aspiration_window_tests {
    ...
    fn test_search_engine_aspiration_integration() {
        ...
        let result = engine.apply_aspiration_window_preset(AspirationWindowPlayingStyle::Aggressive);
        assert!(result.is_ok());
    ...
    fn test_aspiration_window_presets() {
        ...
        let aggressive_preset = engine.get_aspiration_window_preset(AspirationWindowPlayingStyle::Aggressive);
        assert!(aggressive_preset.base_window_size < 50);
        
        // Test conservative preset
        let conservative_preset = engine.get_aspiration_window_preset(AspirationWindowPlayingStyle::Conservative);
        assert!(conservative_preset.base_window_size > 50);
        
        // Test balanced preset
        let balanced_preset = engine.get_aspiration_window_preset(AspirationWindowPlayingStyle::Balanced);
