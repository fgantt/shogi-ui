...
mod comprehensive_tests {
    ...
    fn test_move_ordering_checks_first() {
        ...
        let mut moves = vec![
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, false, None, false, false),
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, true, None, true, false), // Check
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, true, None, false, false), // Capture
        ];
    ...
    fn test_move_ordering_mvv_lva() {
        ...
        let mut moves = vec![
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, true, Some(Piece { piece_type: PieceType::Pawn, player: player.opposite() }), false, false), // Pawn captures pawn
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, true, Some(Piece { piece_type: PieceType::Rook, player: player.opposite() }), false, false), // Pawn captures rook
        ];
    ...
    fn test_move_ordering_promotions() {
        ...
        let mut moves = vec![
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, false, false, None, false, false), // Non-promotion
            Move::new_move(Position { row: 0, col: 0 }, Position { row: 1, col: 1 }, PieceType::Pawn, player, true, false, None, false, false), // Promotion
        ];
