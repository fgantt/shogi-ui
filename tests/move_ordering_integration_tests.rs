...
fn test_move_ordering_with_caching() {
    ...
    let ordered1 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
    ...
    let ordered2 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
...
fn test_move_ordering_with_depth_awareness() {
    ...
    let ordered_shallow = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
    ...
    let ordered_deep = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
...
fn test_move_ordering_with_alpha_beta() {
    ...
    let ordered_narrow = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
    ...
    let ordered_wide = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
...
fn test_move_ordering_with_repeated_positions() {
    ...
    let ordered3 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
...
fn test_move_ordering_with_different_depths_same_position() {
    ...
    let ordered_depth_1 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
    ...
    let ordered_depth_3 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
    ...
    let ordered_depth_5 = engine.order_moves_for_negamax(
        &moves,
        &board,
        &captured,
        player,
...
fn test_move_ordering_integration_with_lmr_context() {
    ...
    let ordered_moves = engine.order_moves_for_negamax(
        ...
        &captured,
        player,
        5, // Deeper depth where LMR is more active
        -100000,
        100000
    );
