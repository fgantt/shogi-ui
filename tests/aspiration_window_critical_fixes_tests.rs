...
mod aspiration_window_critical_fixes_tests {
    ...
    fn test_move_tracking_always_returns_move() {
        ...
        for (alpha, beta) in test_cases {
            ...
            assert!(result.is_some(), "Search should return result for alpha={}, beta={}", alpha, beta);
    ...
    fn test_edge_case_arithmetic() {
        ...
        let result = engine.search_at_depth(&board, &captured_pieces, player, 3, 100, -1000000, 1000000);
    ...
    fn test_performance_under_various_conditions() {
        ...
        for _ in 0..10 {
            let result = engine.search_at_depth(&board, &captured_pieces, player, 3, 50, -1000, 1000);
            assert!(result.is_some());
        }
