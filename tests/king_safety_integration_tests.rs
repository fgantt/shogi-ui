...
mod performance_tests {
    ...
    fn test_castle_recognition_performance() {
        ...
        // Should complete 1000 evaluations in reasonable time
        assert!(duration.as_millis() < 100, "Castle recognition too slow: {}ms", duration.as_millis());
    }
    ...
    fn test_threat_evaluation_performance() {
        ...
        // Should complete 1000 evaluations in reasonable time
        assert!(duration.as_millis() < 500, "Threat evaluation too slow: {}ms", duration.as_millis());
    }
}
