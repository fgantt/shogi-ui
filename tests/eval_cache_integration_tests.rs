...
fn test_end_to_end_cache_with_search() {
    ...
    let result = engine.search_at_depth(&board, &captured_pieces, Player::Black, 3, 1000, -10000, 10000);
...
fn test_cache_correctness_validation() {
    ...
    let eval_with_cache = engine_with_cache.evaluate_position(&board, Player::Black, &captured_pieces);
    let eval_without_cache = engine_without_cache.evaluate_position(&board, Player::Black, &captured_pieces);
...
fn test_cache_with_different_depths() {
    ...
    let score_d1 = evaluator.evaluate_with_context(&board, Player::Black, &captured_pieces, 1, false, false, false, false);
    let score_d5 = evaluator.evaluate_with_context(&board, Player::Black, &captured_pieces, 5, false, false, false, false);
    let score_d10 = evaluator.evaluate_with_context(&board, Player::Black, &captured_pieces, 10, false, false, false, false);
