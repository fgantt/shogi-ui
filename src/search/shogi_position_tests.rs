...
impl ShogiPositionTests {
    ...
    pub fn test_drop_move_validation() -> bool {
        ...
        let is_valid = ShogiMoveValidator::validate_drop_move(&valid_drop, &board, &captured_pieces);
        
        // Invalid drop move (no piece in hand)
        let captured_empty = CapturedPieces::new();
        let is_invalid = ShogiMoveValidator::validate_drop_move(&valid_drop, &board, &captured_empty);
    ...
    pub fn test_capture_move_validation() -> bool {
        ...
        let is_valid = ShogiMoveValidator::validate_capture_move(&valid_capture, &board, &captured_pieces);
        ...
        let is_invalid = ShogiMoveValidator::validate_capture_move(&invalid_capture, &board, &captured_pieces);
    ...
    pub fn test_promotion_move_validation() -> bool {
        ...
        let is_valid = ShogiMoveValidator::validate_promotion_move(&valid_promotion, &board, &captured_pieces);
        ...
        let is_invalid = ShogiMoveValidator::validate_promotion_move(&invalid_promotion, &board, &captured_pieces);
