...
impl ZobristHasher {
    ...
    pub fn update_hash_for_repetition(&self, hash: u64, old_state: RepetitionState, new_state: RepetitionState) -> u64 {
...
mod tests {
    ...
    fn test_hash_position_consistency() {
        ...
        let hash1 = hasher.hash_position(&board, Player::Black, &captured_pieces, RepetitionState::None);
        let hash2 = hasher.hash_position(&board, Player::Black, &captured_pieces, RepetitionState::None);
    ...
    fn test_hash_position_different_players() {
        ...
        let hash_black = hasher.hash_position(&board, Player::Black, &captured_pieces, RepetitionState::None);
        let hash_white = hasher.hash_position(&board, Player::White, &captured_pieces, RepetitionState::None);
