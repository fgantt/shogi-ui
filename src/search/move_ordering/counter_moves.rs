...
impl CounterMoveManager {
    ...
    pub fn add_counter_move<F>(&mut self, opponent_move: Move, counter_move: Move, moves_equal: F, max_counter_moves: usize) -> bool
    where
        F: Fn(&Move, &Move) -> bool,
    {
    ...
    pub fn is_counter_move<F>(&self, move_: &Move, opponent_last_move: Option<&Move>, moves_equal: F) -> bool
    where
        F: Fn(&Move, &Move) -> bool,
    {
