...
impl ShogiHashHandler {
    ...
    pub fn get_position_hash(
        ...
        self.zobrist_hasher.hash_position(board, player, captured_pieces, repetition_state)
    }
    ...
    pub fn validate_hash_uniqueness(&self, hash: u64, _board: &BitboardBoard, _captured_pieces: &CapturedPieces) -> bool {
...
impl ShogiMoveValidator {
    ...
    pub fn validate_promotion_move(
        ...
        let from_promotion_zone = move_.from.map_or(false, |from| {
            match move_.player {
