...
mod search_integration_tests {
    ...
    fn test_basic_search_integration() {
        ...
        let result = engine.search_at_depth(&board, &captured_pieces, player, 3, 1000, -10000, 10000);
    ...
    fn test_negamax_integration() {
        ...
        let legal_moves = engine.move_generator.generate_legal_moves(&board, player, &captured_pieces);
        
        if !legal_moves.is_empty() {
            // Test move ordering integration
            let ordered_moves = engine.order_moves_for_negamax(&legal_moves, &board, &captured_pieces, player, 3, -10000, 10000);
    ...
    fn test_quiescence_integration() {
        ...
        if !noisy_moves.is_empty() {
            let ordered_moves = engine.sort_quiescence_moves_advanced(&noisy_moves, &board, &captured_pieces, player);
    ...
    fn test_iterative_deepening_integration() {
        ...
        let result = engine.search_at_depth(&board, &captured_pieces, player, 2, 1000, -10000, 10000);
    ...
    fn test_move_ordering_performance() {
        ...
        if legal_moves.len() > 3 {
            ...
            for _ in 0..10 {
                let _ordered_moves = engine.order_moves_for_negamax(&legal_moves, &board, &captured_pieces, player, 3, -10000, 10000);
            }
    ...
    fn test_move_ordering_error_handling() {
        ...
        let ordered_moves = engine.order_moves_for_negamax(&empty_moves, &board, &captured_pieces, player, 3, -10000, 10000);
        assert!(ordered_moves.is_empty());
    }
    ...
    fn test_search_correctness_with_move_ordering() {
        ...
        let result1 = engine.search_at_depth(&board, &captured_pieces, player, 2, 1000, -10000, 10000);
        let result2 = engine.search_at_depth(&board, &captured_pieces, player, 2, 1000, -10000, 10000);
    ...
    fn test_search_performance_benchmarks() {
        ...
        let result = engine.search_at_depth(&board, &captured_pieces, player, 3, 2000, -10000, 10000);
...
mod search_performance_tests {
    ...
    fn benchmark_move_ordering_performance() {
        ...
        if legal_moves.len() > 5 {
            ...
            assert!(avg_time_per_iteration < 1000.0, 
                "Move ordering too slow: {}μs per iteration", avg_time_per_iteration);
        }
    }
    ...
    fn benchmark_search_performance() {
        ...
        for _ in 0..iterations {
            let _result = engine.search_at_depth(&board, &captured_pieces, player, 3, 1000, -10000, 10000);
        }
        ...
        assert!(avg_time_per_search < 500.0, 
            "Search too slow: {}ms per search", avg_time_per_search);
    }
    ...
    fn benchmark_quiescence_performance() {
        ...
        if noisy_moves.len() > 2 {
            ...
            for _ in 0..iterations {
                let _ordered_moves = engine.sort_quiescence_moves_advanced(&noisy_moves, &board, &captured_pieces, player);
            }
            ...
            assert!(avg_time_per_iteration < 100.0, 
                "Quiescence move ordering too slow: {}μs per iteration", avg_time_per_iteration);
        }
    }
}
